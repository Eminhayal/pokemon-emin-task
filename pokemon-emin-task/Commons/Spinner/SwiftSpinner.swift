...
//  pokemon-emin-task
//
//  Created by Emin Hayal on 23.04.2022.
//

import UIKit
import Foundation

public class SwiftSpinnerLib: UIView {
   ...
   // MARK: - Singleton
    ...
    //
    public static let shared = SwiftSpinnerLib(frame: CGRect.zero)
    ...
    @discardableResult
    public class func show(_ title: String, animated: Bool = true) -> SwiftSpinnerLib {
        let spinner = SwiftSpinnerLib.shared
        ...
        if spinner.superview == nil {
            ...
            UIView.animate(withDuration: SwiftSpinnerLib.standardAnimationDuration, delay: 0.0, options: .curveEaseOut, animations: {
                ...
                NotificationCenter.default.addObserver(
                    spinner,
                    selector: #selector(SwiftSpinnerLib.orientationChangedAction),
            ...
            show(delay: SwiftSpinnerLib.standardAnimationDuration, title: title, animated: true)
        }
    ...
    /// - Returns: The instance of the spinner
    @discardableResult
    public class func show(duration: Double, title: String, animated: Bool = true, completion: (() -> ())? = nil) -> SwiftSpinnerLib {
        let spinner = SwiftSpinnerLib.show(title, animated: animated)
        spinner.delay(duration) {
            SwiftSpinnerLib.hide {
                completion?()
            }
        }
        return spinner
    ...
    public class func show(delay: Double, title: String, animated: Bool = true) {
        ...
        SwiftSpinnerLib.shared.delay(delay, completion: {
            if let index = delayedTokens.firstIndex(of: token) {
                delayedTokens.remove(at: index)
                SwiftSpinnerLib.show(title, animated: animated)
            }
        })
    }
    ...
    /// - Returns: The instance of the spinner
    @discardableResult
    public class func show(progress: Double, title: String) -> SwiftSpinnerLib {
        let spinner = SwiftSpinnerLib.show(title, animated: false)
    ...
    @objc func orientationChangedAction() {
        if let _ = SwiftSpinnerLib.containerView() {
            SwiftSpinnerLib.shared.setNeedsLayout()
        }
    }
    
    public func updateFrame() {
        if let containerView = SwiftSpinnerLib.containerView() {
            SwiftSpinnerLib.shared.frame = containerView.bounds
            containerView.bringSubviewToFront(SwiftSpinnerLib.shared)
        }
    }
